<?php
  ...
  Chapter::set_database($database);
  Plant::set_database($database);
  Artifact::set_database($database);
  Radiocarbon::set_database($database);
  StableIsotope::set_database($database);
  Update::set_database($database);
